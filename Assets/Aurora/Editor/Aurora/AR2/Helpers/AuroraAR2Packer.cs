...
{
    /// <summary>
    /// Aurora Shader AR2 included helper. Packs metallic, occlusion, illumination, curvature textures into an Aurora swizzle texture.
    /// WIP!
    /// </summary>
    public class AuroraAR2Packer : EditorWindow
    {
        private static AuroraAR2Packer window;
        ...
        {
            window = (AuroraAR2Packer)EditorWindow.GetWindow(typeof(AuroraAR2Packer));
