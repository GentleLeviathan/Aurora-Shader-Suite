...
namespace GentleShaders.Aurora.A3.Helpers
{
    /// <summary>
    ...
    /// WIP!
    /// </summary>
    public class AuroraA3Packer : EditorWindow
    {
        private static AuroraA3Packer window;
        ...
        {
            window = (AuroraA3Packer)EditorWindow.GetWindow(typeof(AuroraA3Packer));
