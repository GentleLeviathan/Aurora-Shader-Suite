...
namespace GentleShaders.Aurora.AR2
{
    ...
    /// WIP!
    /// </summary>
    public class AuroraAR2AboutWindow : EditorWindow
    {
        GUIStyle header;
        GUIStyle boldLabels;
        GUIStyle common;
        ...
        private int page = 0;
        private static AuroraAR2AboutWindow window;

        public static void Init()
        {
            window = (AuroraAR2AboutWindow)EditorWindow.GetWindow(typeof(AuroraAR2AboutWindow));
            window.titleContent = new GUIContent("Aurora AR2 - About");
        ...
        {
            GUILayout.Space(5f);
            GUILayout.Label("About the Aurora AR2 Shader", header);
            GUILayout.Space(10f);
        }
