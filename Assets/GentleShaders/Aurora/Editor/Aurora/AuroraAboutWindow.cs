...
namespace GentleShaders.Aurora
{
    ...
    public class AuroraAboutWindow : EditorWindow
    {
        ...
        private void A3Page()
        {
            ...
            GUILayout.Label("i.e. Texture Set 0 gets 0-1 on the U-dimension, 0-1 on the V-dimension.", common);
            GUILayout.Label("i.e. Texture Set 1 gets 1-2 on the U-dimension, 0-1 on the V-dimension, and so on.", common);
            GUILayout.Space(30f);
